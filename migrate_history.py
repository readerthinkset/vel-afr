"""
Migrate phrase history to Afrikaans format
Converts legacy keys ('japanese', 'telugu', 'korean') -> 'afrikaans'
...
if HISTORY_FILE.exists():
    ...
    print(f"Migrated {updated_count} phrases to Afrikaans format")
    if updated_count > 0:
    ...
    print("Ready for new Afrikaans content generation")
else:
